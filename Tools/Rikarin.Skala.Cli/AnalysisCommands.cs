...
public static partial class SkalaCommandLine {
    ...
    static Command CreateCheckCommand() {
        ...
        var noNewSuppressions = new Option<bool>("--no-new-suppressions") {
            Description = "Fail on a suppression added since the ref: #pragma, [SuppressMessage], an .editorconfig severity, or a baseline entry."
        };
        ...
        foreach (var option in new Option[] {
                ...
                showSuppressions, rules, define, noFormatting, resharperSeverities, since, baseline, noNewSuppressions,
                record, summary, duplication
            }) {
