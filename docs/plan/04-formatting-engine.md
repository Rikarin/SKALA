...
**32** keys in `options.json`; 27 was the sum of the seventeen then-honoured and the ten then-refused,
a sum of two sub-lists mistaken for the whole. And 17 went stale the moment four of the refusals were
