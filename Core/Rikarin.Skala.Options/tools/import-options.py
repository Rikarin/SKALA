...
STANDARD_OPTIONS = {
    ...
    "max_line_length": (
        "int",
        "File",
        "The standard EditorConfig column limit. ReSharper reads skala_max_line_length "
...
# `resharper_continuous_line_indent`, `skala_prefer_wrap_around_eq`, `skala_int_align_eq`,
...
UNDOCUMENTED_CSHARP_KEYS = {
    ...
    "skala_align_multiline_type_parameter_list": ("bool", "TypeParameterList"),
    "resharper_apply_on_completion": ("bool", "Editor"),
    "skala_configure_await_analysis_mode": ("string", "AwaitExpression"),
    "skala_keep_nontrivial_alias": ("bool", "UsingDirective"),
    "skala_wrap_lines": ("bool", "Wrapping"),
    ...
    "skala_disable_blank_line_changes": ("bool", "Formatter"),
    "skala_disable_formatter": ("bool", "Formatter"),
    "skala_disable_indenter": ("bool", "Formatter"),
    "skala_disable_int_align": ("bool", "Formatter"),
    "skala_disable_line_break_changes": ("bool", "Formatter"),
    "skala_disable_line_break_removal": ("bool", "Formatter"),
    "skala_disable_space_changes": ("bool", "Formatter"),
    ...
    "skala_empty_string": ("string", "Literal"),
    "skala_enforce_line_ending_style": ("bool", "File"),
    ...
    "skala_formatter_off_tag": ("string", "Formatter"),
    "skala_formatter_on_tag": ("string", "Formatter"),
    "skala_formatter_tags_accept_regexp": ("bool", "Formatter"),
    "skala_formatter_tags_enabled": ("bool", "Formatter"),
    "resharper_ignore_space_preservation": ("bool", "Formatter"),
    "skala_indent_break_from_case": ("bool", "SwitchSection"),
    "skala_keep_existing_lambda_and_anonymous_function_parens_arrangement": ("bool", "Lambda"),
    "resharper_keep_existing_line_break_before_declaration_body": ("bool", "DeclarationBody"),
    "skala_keep_user_wrapping": ("bool", "Wrapping"),
    ...
    "skala_place_primary_constructor_initializer_on_same_line": ("bool", "PrimaryConstructor"),
    "skala_place_single_method_argument_lambda_on_same_line": ("bool", "Lambda"),
    ...
    "skala_remove_only_unused_aliases": ("bool", "UsingDirective"),
    "skala_remove_spaces_on_blank_lines": ("bool", "File"),
    "resharper_remove_this_qualifier": ("bool", "MemberAccess"),
    "resharper_remove_unused_only_aliases": ("bool", "UsingDirective"),
    "skala_sort_usings": ("bool", "UsingDirective"),
    "skala_space_after_triple_slash": ("bool", "XmlDocComment"),
    "skala_space_before_colon_in_ctor_initializer": ("bool", "ConstructorInitializer"),
    "skala_space_before_trailing_comment_text": ("bool", "Comment"),
    "skala_space_within_spread_pattern": ("bool", "ListPattern"),
    ...
    "skala_use_indent_from_vs": ("bool", "Indentation"),
    "resharper_use_indents_from_main_language_in_file": ("bool", "Indentation"),
    "skala_use_old_engine": ("bool", "Formatter"),
    ...
    "skala_apply_auto_detected_rules": ("bool", "Indentation"),
    "skala_autodetect_indent_settings": ("bool", "Indentation"),
    "skala_xmldoc_insert_final_newline": ("bool", "XmlDocComment"),
    "skala_xmldoc_wrap_lines": ("bool", "XmlDocComment"),
    ...
    "skala_int_align_declaration_names": ("bool", "IntAlign"),
    "skala_int_align_enum_initializers": ("bool", "IntAlign"),
    "skala_int_align_eq": ("bool", "IntAlign"),
    ...
    "skala_prefer_wrap_around_eq": ("string", "Assignment"),
    ...
    "skala_wrap_after_expression_lbrace": ("bool", "Initializer"),
    ...
    "skala_wrap_before_comma_in_base_clause": ("bool", "BaseList"),
    "skala_wrap_before_expression_rbrace": ("bool", "Initializer"),
...
def build(repo: str, cache: str) -> dict:
    ...
    #
    # A form shared with a language Skala does not implement — `skala_wrap_arguments_style` is
        ...
        add(
            {
                ...
                # Tier C is matched on any spelling: `skala_old_engine` canonicalises to
                # `skala_old_engine`, and the plan names the generic spelling.
