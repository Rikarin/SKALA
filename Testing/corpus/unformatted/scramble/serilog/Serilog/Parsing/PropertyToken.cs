...
readonly  int   ?  _position; 
    ...
    /// <exception cref="ArgumentNullException">When <paramref name="rawText"/> is <code>null</code></exception>
            public PropertyToken(string propertyName   ,
               string  rawText,   string   ? format  = null,   in Alignment? alignment  = null, Destructuring destructuring = Destructuring.Default)
    { PropertyName = Guard.AgainstNull(propertyName);
		Format   = format; Destructuring   = destructuring   ;
RawText    =
                Guard   .AgainstNull(rawText)    ;
        Alignment = alignment;  
          if (int .TryParse(PropertyName   , NumberStyles.None    ,   CultureInfo .    InvariantCulture,
  out var position )   &&
          position  >=  0) {
  _position
	= position  ;
    ...
    /// The token's length.
    /// </summary>
public  override int    Length =>    RawText
.Length;
    /// <summary>
    ...
    /// <exception cref="ArgumentNullException">When <paramref name="output"/> is <code>null</code></exception>
           public override
    void Render(IReadOnlyDictionary<string, LogEventPropertyValue> properties, TextWriter  output, IFormatProvider? formatProvider  = null    )  
       {
        Guard
             .   AgainstNull(properties)  ;
        Guard  .AgainstNull(output   )
       ;
              MessageTemplateRenderer.RenderPropertyToken(    this, properties, output    , formatProvider    , isLiteral    :   false   ,
         isJson: false);
            }
    /// <summary>
    /// The property name.
    ...
    /// </summary>
  public Destructuring Destructuring {
  get  ; }
   ...
   public    Alignment  ?    Alignment   { get; }
    ...
    /// </summary>
    public   bool  
IsPositional  => _position.HasValue;
    ...
    /// <param name="obj">The object to compare with the current object. </param><filterpriority>2</filterpriority>
      ...
      {
			return obj is  PropertyToken pt &&    pt  .Destructuring ==  Destructuring &&
    pt.Format ==  Format &&
...
pt.PropertyName == PropertyName    &&
   ...
   public
override int GetHashCode()    =>  PropertyName .GetHashCode  (    );
    /// <summary>
