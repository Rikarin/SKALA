...
IFormatProvider? formatProvider = null)
 {
var fmtProvider   =   formatProvider ?? CultureInfo.CurrentCulture; var writer = _pooledWriter;
        _pooledWriter =  null;   
       ...
       ReusableStringWriter   (IFormatProvider? formatProvider    ) :   base( formatProvider ?? CultureInfo.
CurrentCulture) 
       {
    }
...
if (  !disposing)  {
  ...
  return;
         ...
         var sb = GetStringBuilder  (   ); if (   sb.Capacity > StringBuilderCapacityThreshold)
       {  base    .  Dispose(disposing);
       return; }
