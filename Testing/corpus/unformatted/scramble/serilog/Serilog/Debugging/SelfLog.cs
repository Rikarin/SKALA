    ...
    public static class SelfLog {
        ...
        class SelfLogFailureListener : ILoggingFailureListener {
            public void OnLoggingFailed(
                ...
                SelfMetrics.DiagnosticsDefaultFailureListenerLoggingFailures.Add(
                    1,
                    tags
                );
                ...
                if (
                    ...
                    o.
                        Invoke(
                            string.Format(
                                $"{DateTime.UtcNow:o} {sender.GetType()}: {message} ({kind}, {count} events){Environment.NewLine}{exception}"
                            )
                        );
                } else {
                    o
        ...
        /// <summary>
        ///     An <see cref="ILoggingFailureListener" /> that writes diagnostic information to <see cref="SelfLog" />.
        ///     Sinks
