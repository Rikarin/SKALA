...
class KeyValuePairSettings : ILoggerSettings {
    ...
    public void Configure(LoggerConfiguration loggerConfiguration) {
        ...
        if (directives.TryGetValue(
            ...
            var globalMinimumLevelSwitch = LookUpSwitchByName(
                minimumLevelControlledByLevelSwitchName,
    ...
    internal static IEnumerable<Assembly> LoadConfigurationAssemblies(IReadOnlyDictionary<string, string> directives) {
        ...
        foreach (var usingDirective in directives.Where(d =>
                     d.Key.Equals(UsingDirective) || d.Key.StartsWith(UsingDirectiveFullFormPrefix)
                 )) {
