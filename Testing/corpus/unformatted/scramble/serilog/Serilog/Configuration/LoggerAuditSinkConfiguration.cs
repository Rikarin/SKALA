...
/// </summary>
 public class   LoggerAuditSinkConfiguration
         ...
         readonly LoggerSinkConfiguration _sinkConfiguration;
            ...
            internal LoggerAuditSinkConfiguration( LoggerConfiguration loggerConfiguration ,   
 ...
 public LoggerConfiguration    Sink<   TSink>( LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum,
        LoggingLevelSwitch?  levelSwitch = null   ) where  TSink : ILogEventSink   , new(   )
    ...
    {
        return _sinkConfiguration .Logger(configureLogger, restrictedToMinimumLevel
         ,    levelSwitch) ;   
          }
    /// <summary>
    /// Audit log events to a sub-logger, where further processing may occur. Events through
