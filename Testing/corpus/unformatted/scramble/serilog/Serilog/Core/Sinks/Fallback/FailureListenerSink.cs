...
ILogEventSink   _inner;
        ...
        public FailureListenerSink  
        (ILogEventSink inner   ,  ILoggingFailureListener   listener )   
    {
  ...
  { sfl.SetFailureListener    (listener);
         ...
         try
     {
      ...
      . Emit(logEvent);
        ...
        {
     _listener    . OnLoggingFailed(this,
LoggingFailureKind.    Permanent,    "failed emitting an event", [ logEvent ],  ex   );
