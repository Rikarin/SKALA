...
namespace
    ...
    Matching {
        ...
        public static Func<LogEvent, bool> FromSource
            (string source) {
        ...
        ///     When <paramref name="propertyName" /> is <code>null</code>
        /// </exception>
        ...
        ///     When <paramref name="propertyName" /> is <code>null</code>
        /// </exception>
        public static Func<LogEvent, bool> WithProperty(
            string propertyName,
            object scalarValue
        ) {
            Guard.AgainstNull
        ...
        public static Func<LogEvent, bool> WithProperty<TScalar>(string propertyName, Func<TScalar, bool> predicate) {
            ...
            return e => {
                if
                    (!e.Properties.TryGetValue(propertyName, out var propertyValue))
                        return false;

                return propertyValue is ScalarValue { Value: TScalar value } && predicate(value);
            };
        }
    }
