...
class EnricherStack : IEnumerable<ILogEventEnricher>
{
    ...
    {
        _under =
Guard.AgainstNull (under  );
          Count = under.    Count + 1  ;
        _top = top;
 }
   public   Enumerator  GetEnumerator()   => new  (  this
);  
    IEnumerator< ILogEventEnricher>
			IEnumerable   <ILogEventEnricher   >.   GetEnumerator() =>  new Enumerator(this);
  ...
  GetEnumerator  () => new Enumerator(    this);
    ...
    public static    EnricherStack Empty   { get  ;   } = new
             ...
             public
    bool   IsEmpty => _under == null;
        
               public EnricherStack Push (    ILogEventEnricher  t) => new(this
		, t) ;  
 ...
 ILogEventEnricher   ? _current;
  public Enumerator   (EnricherStack   stack
        ...
        { _stack = stack ;
         _top  =   stack; _current = null    ;
}
   public bool    MoveNext()    {
       if (    _top.IsEmpty)  return  false;
             _current
        = _top.Top;
     _top
             = _top ._under!;
