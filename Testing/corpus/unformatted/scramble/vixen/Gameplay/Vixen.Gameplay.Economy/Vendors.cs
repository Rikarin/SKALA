...
namespace Vixen.
    ...
    public sealed class VendorState {
        ...
        > BuybackFor(PlayerId player) =>
            buyback.
            TryGetValue(player, out var entries)
                ? entries
                : [];
        ...
        public VendorRefusal Buy(
            ...
            if (!result.Ok) {
                return result.Verdict == EconomyVerdict.Insufficient
                    ? VendorRefusal.Insufficient
                    : VendorRefusal.Refused;
            }
