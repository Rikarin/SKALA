...
/// </summary>
         public sealed class IrModule (    string   name  )  { readonly List<IrFunction > functions    = [    ];
    readonly
List   <IrShader> shaders =    []    ;
          readonly
...
Name; 
    internal  void Add (    IrStructType  structType) => structs.    Add(structType); internal void Add(    IrFunction function)   =>  functions   . Add(function);
    internal void Add(  IrShader
