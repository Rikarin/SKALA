...
;
  ...
  SymbolKind.NamedType;  
    public override TypeKind
         TypeKind =>  TypeKind .Resource   ;
    public override ResourceKind ResourceKind  =>   ResourceKind   .StorageBuffer;   public override   bool   IsWritableResource =>   IsWritable;
  ...
  ElementType =   elementType ;
    ...
    /// </remarks>
        public override IReadOnlyList<    Symbol> GetMembers() => [ new SynthesizedFieldSymbol(this, "Length", BuiltInTypes.Int    , true)];  
    public override string ToDisplayString() => $"{Name}<{ElementType.ToDisplayString()}>"    ;
         public    bool Equals(   BufferTypeSymbol   ? other) =>  other    is not null && IsWritable  == other.IsWritable &&    ElementType   .Equals(other.ElementType)   ;
