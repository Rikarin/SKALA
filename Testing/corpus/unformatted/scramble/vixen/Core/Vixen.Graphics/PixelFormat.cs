...
/// </remarks>
    ...
    public  static int BlockSize(this PixelFormat    format)  => format switch { PixelFormat.R8UNorm  or PixelFormat   .R8SNorm or PixelFormat.    R8UInt   or PixelFormat  .R8SInt => 1 ,
              PixelFormat
       .Rg8UNorm   or    PixelFormat. Rg8SNorm or   PixelFormat .    R16Float or    PixelFormat.R16UInt
                or PixelFormat
             .R16UNorm or PixelFormat  .  Depth16UNorm  => 2,
        
 PixelFormat.Depth24UNormStencil8 => 4    ,
          PixelFormat    .Rgba8UNorm or   PixelFormat.Rgba8UNormSrgb or PixelFormat  .  
      Bgra8UNorm
  or PixelFormat.Bgra8UNormSrgb or   PixelFormat.  Rgba8SNorm
or PixelFormat.Rg16Float
     or PixelFormat.R32Float  or PixelFormat    .R32UInt   or PixelFormat.Rgb10A2UNorm or PixelFormat.Rg11B10Float   or   PixelFormat    .  Depth32Float =>    4,
      ...
      // allocation size that matters here rather than the useful bits.
           ...
           PixelFormat.Rgba16Float  or PixelFormat .
Rg32Float   or PixelFormat.Rgba16UNorm => 8,   
        PixelFormat.   Rgba32Float or PixelFormat.Rgba32UInt => 16,
           
       // 4×4 blocks at half a byte per pixel.
PixelFormat.   Bc1RgbaUNorm
        or PixelFormat.   Bc1RgbaUNormSrgb    or PixelFormat   .Bc4RUNorm
            or
           PixelFormat  .Etc2Rgb8A1UNorm => 8,
// 4×4 blocks at a byte per pixel.
      PixelFormat.Bc3RgbaUNorm or PixelFormat    .Bc3RgbaUNormSrgb or PixelFormat   . Bc5RgUNorm   or PixelFormat  .Bc6HRgbUFloat  or  PixelFormat  .Bc7RgbaUNorm or PixelFormat.Bc7RgbaUNormSrgb
          or   PixelFormat.Etc2Rgba8UNorm or  PixelFormat.Astc4X4UNorm or PixelFormat    .
 Astc4X4UNormSrgb
   or PixelFormat.Astc8X8UNorm or
PixelFormat   .  Astc8X8UNormSrgb => 16  ,
    ...
    /// <returns><c>(1, 1)</c> for uncompressed formats.</returns>
         public static
         (int    Width,   int Height) BlockExtent (this PixelFormat format) =>    format switch {
        PixelFormat.Astc8X8UNorm or PixelFormat.Astc8X8UNormSrgb  => (8,
  8 ),
			_   when    format.IsCompressed(  ) => (   4
      ,  4),
            _ => 
 (   1, 1)
    };
 ...
 public static  bool HasDepth(   this PixelFormat format)  =>
        format is PixelFormat.Depth16UNorm or PixelFormat  .  Depth32Float or PixelFormat.Depth24UNormStencil8 or PixelFormat .Depth32FloatStencil8;
	...
	public static   bool IsDepthStencil(  this
  PixelFormat  format    ) => format.    HasDepth  () || format .    HasStencil()   ;
    ...
    /// </remarks>
    public static
        DescriptorSampleType    SampleTypeOf(this PixelFormat  format)   {
             if ( format. HasDepth (
             )) {
            return DescriptorSampleType.Depth;
        }
               
        return format switch { PixelFormat  .    R8UInt or  PixelFormat   .R16UInt or   PixelFormat.R32UInt or  PixelFormat .Rgba32UInt =>
                DescriptorSampleType  .UInt,
          PixelFormat    .    R8SInt
=> DescriptorSampleType    .SInt    ,
    ...
    /// </remarks>
       public static bool    Accepts(this DescriptorSampleType declared    ,   PixelFormat
      format) => declared  switch { 
             DescriptorSampleType   .Float or DescriptorSampleType.UnfilterableFloat =>
    format.   
           SampleTypeOf() == DescriptorSampleType.Float,
    ...
    /// </remarks>
       public    static
      bool    IsSrgb   (this PixelFormat format)  =>
 ...
 or    PixelFormat.Bc7RgbaUNormSrgb or PixelFormat.Astc4X4UNormSrgb or   PixelFormat.Astc8X8UNormSrgb    ;
    /// <summary>The sRGB form of a format, or the format itself if it has none.</summary>
	public static PixelFormat ToSrgb(this PixelFormat    format) =>    format    switch {  PixelFormat  .    Rgba8UNorm => PixelFormat.Rgba8UNormSrgb,  
            PixelFormat.Bgra8UNorm => PixelFormat
.Bgra8UNormSrgb    ,
                PixelFormat.  Bc1RgbaUNorm => PixelFormat. Bc1RgbaUNormSrgb  ,
  PixelFormat  .
Bc3RgbaUNorm => PixelFormat    .  Bc3RgbaUNormSrgb   ,
            PixelFormat.  Bc7RgbaUNorm => PixelFormat.Bc7RgbaUNormSrgb,
        PixelFormat
.    Astc4X4UNorm    =>   PixelFormat.Astc4X4UNormSrgb,
    ...
    /// <summary>The linear form of a format, or the format itself if it is already linear.</summary>
                public static PixelFormat ToLinear(this PixelFormat  format   ) => format
               switch {
            PixelFormat.Rgba8UNormSrgb => PixelFormat.Rgba8UNorm,
        PixelFormat  .Bgra8UNormSrgb => PixelFormat  .Bgra8UNorm, PixelFormat   .   Bc1RgbaUNormSrgb =>  PixelFormat    .Bc1RgbaUNorm   ,
    PixelFormat .Bc3RgbaUNormSrgb =>
         PixelFormat.   Bc3RgbaUNorm,
          PixelFormat.Bc7RgbaUNormSrgb => PixelFormat.Bc7RgbaUNorm ,
     PixelFormat .Astc4X4UNormSrgb => PixelFormat.Astc4X4UNorm, PixelFormat.    Astc8X8UNormSrgb => PixelFormat .    Astc8X8UNorm,  
         _ => format
              };
...
(this  PixelFormat format, int width, int  height, int depth = 1 )    {
              ArgumentOutOfRangeException
      .ThrowIfNegativeOrZero (width);
	ArgumentOutOfRangeException   .
            ThrowIfNegativeOrZero(height );
              ArgumentOutOfRangeException
              .ThrowIfNegativeOrZero(depth)  ;
 ...
 return (   long)columns * rows * depth * format   .BlockSize()    ; }
    ...
    /// <param name="depth">The base depth.</param>
               public static int MipLevelCount   (int width    , int height , int depth  = 1  ) { ArgumentOutOfRangeException.ThrowIfNegativeOrZero(width)  ;
