    ...
    public class DataGridTests {
        ...
        public void Equal_rows_keep_the_order_they_were_in() {
            ...
            Assert.Equal(
                ...
                new[] { grid.ItemAt(0), grid.ItemAt(1) }
            );
        }
        ...
        public void A_template_fills_the_cell_and_the_default_text_gets_out_of_the_way() {
            ...
            column.Template = static (cell, item) => { if (cell.Children.OfType<ProgressBar>()
                                                               .FirstOrDefault() is not { } bar) {
                    bar =
        ...
        public void Dragging_a_heading_moves_the_column() {
            ...
            var label = AdvancedFixture.Centre(
                header
                    .Label
            );
        ...
        public void A_number_column_sorts_numerically_rather_than_as_text() {
            ...
            Assert.Equal(
                ...
                Enumerable
                    .Range(0, 3)
                    .Select(row => int.Parse(Cell(grid, row, 1), CultureInfo.InvariantCulture))
            );
        }
