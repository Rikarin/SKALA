...
sealed class Fleet {
    ...
    public void
        MoveTo(Entity entity, Vector3 position) =>
        World.Get<LocalTransform>(entity).Position = position;
    ...
    public
        PerceivedTargets Perceived(Entity listener) =>
        System.PerceivedBy(World, listener)!;
