    ...
    public void TheLoseSightRadiusIsWhatStopsTheFlicker() {
        ...
        static int Transitions(float loseSight) {
            ...
            foreach
                ...
                fleet.Step();
                var now = fleet.Perceived(listener)
                    .IsPerceiving(
                        SenseMask.
                        Sight
                    );
...
public class EventSenseTests {
    ...
    public void ANoiseCarriesAsFarAsItIsLoud() {
        ...
        Assert.True(
            fleet.
                Perceived(near)
                .IsPerceiving(SenseMask.Hearing)
        );
...
public class
    ...
    public void DistanceLodStretchesTheIntervalInBands() {
        ...
        Assert.Equal(
            0.1f,
            FixedRateGovernor.
            Instance.IntervalFor(config, 100f),
            4
        );
    }
