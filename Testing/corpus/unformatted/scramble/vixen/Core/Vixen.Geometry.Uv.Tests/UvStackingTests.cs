...
namespace Vixen.
    ...
    public class UvStackingTests {
        ...
        /// <summary>
        ///     A right-angled wedge, optionally reflected in <c>u</c> with its corners in the same order.
        /// </summary>
        /// <remarks>
        ///     ⚠
        ///     <b>
        ...
        static UvIsland Wedge(bool mirrored, float side = 0.25f) {
            var points = new[] {
                new Vector2(0f, 0f), new Vector2(side, 0f), new Vector2(side, side
                    * 0.5f), new Vector2(side * 0.25f, side)
            };
