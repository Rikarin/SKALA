...
/// </remarks>
    ...
    public    ComponentDirectiveSyntax
            ? Component => First  <ComponentDirectiveSyntax>();
...
public    NamespaceDirectiveSyntax
	? Namespace   => First    <    NamespaceDirectiveSyntax    >( );
    ...
    /// </remarks>
         public    IEnumerable<UsingDirectiveSyntax
> Usings {
         get {
 ...
 yield return  @using  ;
    ...
    T? First<T>() where T   : DirectiveSyntax { foreach (var   directive  in Directives  ) {
