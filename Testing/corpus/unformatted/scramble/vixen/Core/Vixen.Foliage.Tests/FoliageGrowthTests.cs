...
public sealed class FoliageGrowthTests {
    ...
    public void AForestGrows() {
        ...
        Assert.True(
            ...
            > result.
            Sown,
            "nothing spread; the forest is only its sowing."
        );
    }
    ...
    public void SaplingsAreSmallerThanTrees() {
        ...
        Assert.True(
            ...
            < scales.Max(),
            "every plant is the same size; age is not scaling."
        );
    ...
    public void TheCapIsAnnouncedRatherThanSilent(
        ...
        Assert.True(
            ...
            Capped
            > 0,
            "a twenty-plant cap over forty thousand square metres refused nothing."
        );
