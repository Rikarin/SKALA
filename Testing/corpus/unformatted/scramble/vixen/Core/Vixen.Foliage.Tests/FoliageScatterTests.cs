...
namespace
    ...
    class FoliageScatterTests {
        ...
        public void A_stamp_places_instances_on_the_ground_under_it() {
            ...
            foreach (var chunk in volume.Chunks) {
                foreach (var instance in chunk.Instances) {
                    Assert.InRange(
                        Vector2.Distance(new(instance.Position.X, instance.Position.Z), new(50f, 50f)),
                        0f,
                        10f
                    );
                }
        ...
        public void
            ...
            var result = FoliageScatter.Stamp(
                volume,
                type,
                Ground.Sloped(slope),
                new(50f, 50f),
        ...
        public void A_layer_filter_refuses_ground_that_is_not_painted_with_it
            ...
            Assert.All(
                Positions
                (volume),
                at => Assert.True(at.X < 50f, $"one landed at x = {at.X}.")
            );
        }
