...
public sealed class TerrainWeightmapTests {
    ...
    public void A_weightmap_round_trips_through_export_and_import() {
        ...
        var round = Built();
        TerrainWeightmap.Import(
            round,
            1,
            bytes,
            terrain.Description.SamplesX,
            terrain.Description
                .SamplesZ
        );
