...
public sealed class TerrainBrushTests {
    ...
    public void TheFourCurvesAreActuallyDifferentShapes() {
        ...
        var spherical = BrushFalloff.Evaluate(
            BrushFalloffKind.Spherical,
            0.5f
        );
        var tip
    ...
    public void ACircleIsRotationallySymmetric() {
        ...
        for
            ...
            Assert.Equal(
                expected,
                brush.
                WeightAt(sample, new(Vector2.Zero)),
                5
            );
        }
    }
        ...
        Gen.Select(
            ...
            .Sample(
                input => {
                    ...
                    for (var step = 0; step
                         <= 64; step++) {
                        var value = brush.WeightAt(
                            new(radius * step / 64f, 0f),
                            stamp
                        );
