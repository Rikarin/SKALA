...
/// <param name="IsHdr">Whether this mode carries a wide-gamut, high-dynamic-range signal.</param>
       public readonly record struct DisplayMode(Int2    Size,   float
			RefreshRate, bool IsHdr) {
    /// <inheritdoc />
             public   override
  string ToString() =>
...
public interface   IDisplayInfo   {
   ...
   DisplayInfo?
    ...
    /// one.</returns>
    bool TryGetForWindow   (IWindow
         window    , [NotNullWhen  (true   )  ] out DisplayInfo ? display) ;
