...
namespace Vixen
    ...
    static class ControlIcons {
        ...
        public static PathBuilder Dash { get; } = Stroke(
            [
                new Vector2(
                    5f,
                    12f
        ...
        public static PathBuilder ChevronUp { get; } =
            Stroke([new Vector2(5f, 15f), new Vector2(12f, 8f), new Vector2(19f, 15f)], 2.2f);
        ...
        public static PathBuilder ChevronRight { get; } = Stroke(
            [
                new Vector2(
                    9f,
                    5f
                ), new Vector2(16f, 12f), new Vector2(9f, 19f)
            ],
            2.2f
        );
        ...
        public static
            ...
            [
                new Vector2(15f, 5f), new Vector2(8f, 12f), new Vector2(
                    15f,
                    19f
                )
            ],
        ...
        ///     </para>
        /// </remarks>
        static PathBuilder Stroke(
            ReadOnlySpan<Vector2
            > points,
            float width
        ) {
