...
string TagName =>   "card"  ;
    ...
    /// <summary>Where the card's content goes.</summary>
            public UiElement Body { get;    private
set;    } = null! ;
    ...
    protected override void OnCreated  () {
                base  .  OnCreated(); Body = Part  (   "card-body"  );
   }
...
/// <summary>A rule between two groups of things.</summary>
 ...
 base    .OnCreated( );
      AddClass(ClassOf(Orientation))    ;    }
                internal static string  ClassOf    (Orientation orientation)  => orientation ==   Orientation.Vertical ? "vertical" : "horizontal";
...
protected override bool  AcceptsFocus =>   false;
    ...
    public string? Title { get => TitlePart.    Text  ;
  ...
  set =>   MessagePart   . Text    = value;   } 
    ...
    /// <summary>The heading's element.</summary>
              public UiElement TitlePart   { get; private set; }
			= null!;
    /// <summary>The message's element.</summary>
    public UiElement MessagePart { get   ;
               private set; } = null!;
 ...
 protected override string? NativeAccessibleName    => Title  ;
    ...
    /// <inheritdoc />
        ...
        Body = Part    (   "alert-body"    )   ; TitlePart = Body   .   Add("alert-title")    ;
 ...
 // nothing calls. A heading and the sentence under it are exactly what the pair is for, and
  ...
  AddAccessibleRelation (AccessibleRelation
.    DescribedBy  , MessagePart)   ;
    } }
...
DescriptionPart. Text ;
    set =>
   DescriptionPart.Text = value   ;
         }
          
    /// <summary>The headline's element.</summary>
      public UiElement   
TitlePart { get; private set; } = null!;
    /// <summary>The description's element.</summary>
    public UiElement DescriptionPart { get
; private set ; } =   null!  ;
...
public Icon Illustration  { get  {
    if (
            icon is   not null) {
  return icon;
            }

                icon  = Part<Icon >()   ; Document   .Move (icon, 0    )    ;
