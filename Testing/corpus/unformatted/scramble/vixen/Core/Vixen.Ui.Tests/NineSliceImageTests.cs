...
namespace Vixen.Ui
    ...
    public class NineSliceImageTests {
        ...
        public void A_hollow_centre_leaves_out_the_middle_and_nothing_else() {
            var geometry = Build(list => list.Add(
                    Sliced(
                        ...
                        200,
                        100,
                        NineSlice.Uniform(16f)
                    ) with { HollowCentre = true }
                )
            );
        ...
        public void A_box_narrower_than_its_own_corners_compresses_them_without_moving_the_texels() {
            ...
            Assert.Equal(
                10f,
                geometry.Vertices[2].Position.
                X,
                4
            );
            Assert.Equal(
                10f,
                geometry.Vertices[2].Position.Y,
                4
            );
