...
// produces the same length and different bytes.
    ...
    public void QuantizationPicksTheSameLevelEverywhere() {
        ...
        var ranges = new (string Name
            , QuantizeRange Range)[] {
                ...
                ("one-bit", new(0f, 1f, 1)), ("full-width", new(-1f, 1f, 32)), ("asymmetric", new(-0.125f, 7.375f, 12))
            };
    ...
    public void
        ...
        var rotations = new ( string Name, Quaternion Value)[] {
            ...
            ("x-largest", new(0.9f, 0.1f, 0.2f, 0.3f)), ("y-largest", new(0.1f, 0.9f, 0.2f, 0.3f)), ("z-largest", new(
                0.1f,
                0.2f,
                0.9f,
                0.3f
...
// it to be discovered.
    ...
    public void AGamesOwnComponentsAreTheSameBytesEverywhere() {
        ...
        var first = world.Create(
            ids.Next(),
            new Replication.ReplicatedPosition {
                X = 0f,
                Y =
                    -1000f,
                Z = 1000f
            },
            new Replication.ReplicatedHealth {
                Value =
                    100
            }
        );
