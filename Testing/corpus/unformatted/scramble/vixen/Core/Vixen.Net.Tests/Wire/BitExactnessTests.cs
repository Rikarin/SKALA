    ...
    public sealed class BitExactnessTests {
        ...
        public void QuantizationPicksTheSameLevelEverywhere() {
            ...
            var ranges = new (string Name
                , QuantizeRange Range)[] {
                    (
                        "unit8", new(0f, 1f, 8)), ("signed16",
                        new(-1000f, 1000f, 16)), ("rotation10", MathCodec.RotationRange),
        ...
        public void AWholeSnapshotIsTheSameBytesEverywhere() {
            ...
            foreach (
                ...
                entities.Add(
                    world.Create(ids.Next(), new NetworkTransform { Position = position, Rotation = rotation })
                );
            }
        ...
        public void AGamesOwnComponentsAreTheSameBytesEverywhere() {
            ...
            registry.Register(
                new Replication.HealthReplicator(
                )
            );
