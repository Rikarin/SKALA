...
/// <typeparam name="T">The element type.</typeparam>
 [InlineArray (    8)] public struct Buffer8<  T> : IInlineBuffer<T>    {
         T element  ;
    /// <inheritdoc />
...
/// <typeparam name="T">The element type.</typeparam>
            [InlineArray(16)   ]
        public struct Buffer16<T> : IInlineBuffer<T  > { T element;
    /// <inheritdoc />
...
/// <typeparam name="T">The element type.</typeparam>
        [    InlineArray  (32)]    public   struct Buffer32<  T>  : IInlineBuffer    <T> {
T element;
