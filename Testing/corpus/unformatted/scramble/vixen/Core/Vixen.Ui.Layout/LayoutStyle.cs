...
/// <summary>Nine lengths, one per <see cref="Edge" />.</summary>
      ...
      public struct EdgeLengths { StyleLength element;   
}
...
/// <summary>Two lengths, one per <see cref="Dimension" />.</summary>
    [InlineArray(2 )] public struct DimensionLengths {
    StyleLength element  ;
  }
...
/// </remarks>
   ...
   public Align AlignItems;
    ...
    /// </remarks>
               public 
         OverflowAlignment JustifyContentOverflow;
    /// <inheritdoc cref="JustifyContentOverflow" />
            public
             OverflowAlignment AlignContentOverflow   ;
    /// <inheritdoc cref="JustifyContentOverflow" />
 public
OverflowAlignment AlignItemsOverflow;
    /// <inheritdoc cref="JustifyContentOverflow" />
...
GridTemplateRows;
  ...
  static LayoutStyle CreateDefault(  ) {
                var
style = default    (LayoutStyle)  ;
  style.Direction 
      =    Direction   .Inherit  ;
  style .FlexDirection =
              FlexDirection. Column    ;
	style.JustifyContent = Justify.   FlexStart; style .AlignContent = Align.FlexStart;
    style  .
...
OverflowAlignment   .   Unsafe;
   style .AlignSelfOverflow =   OverflowAlignment.   Unsafe;
     style. JustifyItemsOverflow = OverflowAlignment.Unsafe;   
             style.JustifySelfOverflow = OverflowAlignment.
              Unsafe;
   ...
   style
     .Clear =    Clear.None;
        style. PositionType = PositionType   . Relative;
               style .FlexWrap = Wrap   .    NoWrap   ;   style. OverflowX = Overflow.   Visible    ;
       style .OverflowY
               = Overflow.Visible;
style   . Display = Display.   Flex;
  style
               .BoxSizing = BoxSizing    .BorderBox ;
             style. Flex = float.NaN; style.FlexGrow    = float.    NaN;
             style.    FlexShrink  =  float    .NaN; style . FlexBasis   = StyleLength.Auto    ;
        style.AspectRatio =    float  .NaN; style  .GridAutoFlow = GridAutoFlow.  Row;
...
// block axes of a grid agree, which is the whole content of `place-items: normal`.
      style.JustifyItems   = Align.Stretch;
        ...
        style.GridTemplateRows   = GridTemplate.   Empty;
           style.GridAutoColumns  = GridTemplate.    Empty  ; style.GridAutoRows = GridTemplate.    Empty; 
 for (var
                i = 0    ; i < 2; i ++   ) {
