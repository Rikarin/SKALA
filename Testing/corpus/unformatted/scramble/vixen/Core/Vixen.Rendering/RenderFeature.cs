...
public RenderSystem?
    ...
    /// </remarks>
    protected  void  Degrade   (string? reason    )   =>
Degraded    = reason    ;
    /// <summary>Adds a sub-feature, which registers its own per-object data.</summary>
                public void Add(SubRenderFeature subFeature) { ArgumentNullException   .ThrowIfNull(subFeature);
 ...
 subFeatures .Add    (subFeature
    ...
    /// <summary>Registers this feature's own per-object data. Called once, when it is added.</summary>
      protected internal    virtual
               void Initialize(RenderSystem system) {  }
    ...
    /// </remarks>
           protected internal virtual void    Extract (
RenderSystem system) { }
...
{ }
    ...
    ///     </para>
    /// </remarks>
			protected internal virtual  void Draw    ( RenderSystem system ,
...
/// </remarks>
public
                abstract class SubRenderFeature {
    ...
    /// <summary>Registers this sub-feature's per-object data. Called once.</summary>
          protected
           internal virtual void Initialize    (    RenderSystem system   ) { }
    ...
    /// <summary>Fills this sub-feature's data for the visible objects.</summary>
               protected
    internal  virtual   void Prepare   (RenderSystem    system) {    }
    /// <inheritdoc />
    public
