...
namespace
    ...
    /// <summary>
    ///     <c>oklab()</c>, <c>oklch()</c> and <c>color-mix()</c>, against oracles that are not this code.
    /// </summary>
    /// <remarks>
    ///     <para>
    ///         <b>
    ...
    public class ColorFunctionTests {
        ...
        public void Oklch_is_the_same_space_in_polar_form(
            string text,
            float r,
            float
            g,
        ...
        public void An_out_of_gamut_colour_is_carried_through_rather_than_clamped() {
            ...
            Assert.True(
                ...
                B
                < 0f,
                $"expected a negative blue channel outside sRGB, got {wide.B}"
            );
        ...
        public void One_percentage_omitted_means_the_other_is_its_complement() {
            ...
            Assert.Equal(
                Color("color-mix(in oklab, white 50%, black 50%)"),
                Color
