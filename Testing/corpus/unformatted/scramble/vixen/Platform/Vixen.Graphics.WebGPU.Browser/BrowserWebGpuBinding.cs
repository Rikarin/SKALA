...
namespace Vixen.Graphics
    ...
    public sealed class BrowserWebGpuBinding : IWebGpuBinding {
        ...
        /// </remarks>
        public static async Task<BrowserWebGpuBinding> CreateAsync(
            BrowserWebGpuOptions
            options
        ) {
        ...
        public WebGpuObject
            ...
            return Wrap(
                WebGpuInterop.CreateShaderModule(
        ...
        public WebGpuObject CreateRenderPipeline(in WgpuRenderPipelineDescriptor descriptor) {
            ...
            if (descriptor
                ...
                Face(depth.Back);
                packer
                    .Float(depth.DepthBiasSlopeScale)
                    .Float(depth.DepthBiasClamp);
            }
        ...
        public WebGpuObject BeginRenderPass
            ...
            packer.
                Reset()
                .Int(descriptor.ColourAttachmentCount)
                .Bool(descriptor.DepthStencil is not null);
        ...
        /// <inheritdoc />
        public void RenderPassSetVertexBuffer(
            WebGpuObject pass,
            uint
            slot,
            WebGpuObject buffer,
        ...
        public void RenderPassSetStencilReference(WebGpuObject pass, uint reference) =>
            WebGpuInterop.SetStencilReference(
                (int)pass.Value,
                reference
            );
        ...
        public
            ...
            WebGpuInterop.DrawIndexedIndirect(
                (int)pass.Value,
                (int)arguments.Value,
                offset
            );
        ...
        /// <inheritdoc />
        public void RenderPassPopDebugGroup(
            WebGpuObject pass
        ) =>
        ...
        /// <inheritdoc />
        public void ComputePassSetPipeline(
            WebGpuObject pass,
            WebGpuObject
            pipeline
        ) =>
        ...
        public void ComputePassDispatchIndirect(WebGpuObject pass, WebGpuObject arguments, long offset) =>
            WebGpuInterop.DispatchIndirect(
                (int)
                pass.Value,
                (int)arguments.Value,
                offset
        ...
        /// <inheritdoc />
        public void ComputePassPushDebugGroup(
            WebGpuObject pass,
            string name
        ) =>
