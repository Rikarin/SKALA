...
public
    ...
    public void No_active_shape_leaves_the_mesh_exactly_as_it_was() {
        ...
        for (
            ...
            Assert.True(
                ...
                $"vertex {index} moved with no weight on it"
            );
        }
    }
    ...
    public void The_render_feature_puts_the_kernels_numbers_in_the_buffer_the_draw_reads() {
        ...
        var id = system
            .Objects.Add(new() { Bounds = new(Vector3.Zero, 1f), Stages = stage.Mask, FeatureIndex = meshes.Index });
