...
namespace Vixen.Graphics
    ...
    public sealed class UiImageTests {
        ...
        public void Interface() {
            ...
            owned.Graph.AddPass(
                "ui",
                pass => { pass.ColourAttachment(colour, LoadAction.Clear, new(0.08f, 0.09f, 0.11f, 1f));
                    pass.SideEffect()
                        ;
        ...
        static UiGeometry Paint(GlyphFieldCache cache) {
            ...
            list.Add(
                new DrawCommand(DrawCommandKind.PathStroke, 0, 0, 0, 0, new Color4(0.4f, 0.9f, 0.5f, 1f), 0, 4) {
                    Offset =
                        list.AddPath(path), Length = path.Count
                }
            );
        ...
        static void AssertTheBoxIsRounded(in Bitmap image) {
            ...
            Assert.True(
                ...
                > 100,
                "the bottom-right corner was cut when it is square"
            );
            Assert.True(
                Blue(
                    image,
        ...
        ///     draws a blue box.
        /// </summary>
        static void AssertTheBoxIsGraded(
            in
            Bitmap image
        ) {
            var top = Blue(
        ...
        static void AssertTheCardIsOverTheShadow
            ...
            Assert.True(
                ...
                > 200,
                "the card is darker than it should be, or is not there"
            );
        }
        ...
        static int Blue(
            ...
            image.Pixels[image.Offset(x, y) + 2];
        ...
        public void Images() {
            ...
            owned.Graph.AddPass(
                ...
                pass => {
                    ...
                    pass.SideEffect(); pass.Execute(graph => renderer.Record(
                            graph.CommandList,
                            geometry,
                            new(Side, Side)
                        )
        ...
        static void AssertTheImageIsUpright(in Bitmap image) {
            ...
            Assert.
                True(Blue(image, 64, 48) > Red(image, 64, 48), "the bottom-left of the upright image is not blueish");
        }
        ...
        static void AssertTheBoxAfterTheImageIsNotTheTexture(in Bitmap image) {
            ...
            Assert
                .True(
                    Red(image, 28, 88) > 150
                    && Green(image, 28, 88) is > 60 and < 200
                    && Blue(
                        image,
                        28,
                        88
