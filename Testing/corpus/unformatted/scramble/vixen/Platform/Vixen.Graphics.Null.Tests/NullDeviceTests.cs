...
namespace
    ...
    NullDeviceTests : IDisposable {
        ...
        public void EveryResourceThatIsTakenComesBack(
            ...
            for (var round = 0; round < 100; round++) {
                ...
                var texture = device.CreateTexture(
                    new(PixelFormat.Rgba8UNorm, 64, 64, TextureUsage.Sampled, Name: "T")
                );
        ...
        public void ATextureLargerThanTheDeviceAllowsIsRefused() {
            ...
            var
            thrown = Assert.Throws<ArgumentException>(() => limited.CreateTexture(
        ...
        public void AWriteOfTheWrongKindIsRefused() {
            ...
            var thrown = Assert.
                Throws<ArgumentException>(() => device.UpdateDescriptorSet
        ...
        public void AnUnboundedBindingNeedsTheCapability(
            ...
            var refused = Assert.
                Throws<ArgumentException>(() => minimum.CreateDescriptorSetLayout(
                        new(
                            DescriptorSetSlot
                                .PerFrame,
                            [
        ...
        public void ACountBufferDrawNeedsItsOwnCapability() {
            using var limited = new NullDevice(
                new() {
                    Features = NullDevice.Everything with {
            ...
            var refused = Assert.Throws
                <InvalidOperationException>(() => list.DrawIndexedIndirectCount(arguments, counts, maxDrawCount: 3));
