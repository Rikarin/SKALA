    ...
    public class ViewportTests {
        ...
        public void Snap_to_floor_drops_the_selection_onto_what_is_under_it_and_undoes() {
            ...
            Assert.Equal(
                before
                    .Y,
                fixture.Scene.World.Read<Vixen.Engine.Transforms.LocalTransform>(crate).Position.Y,
                4
            );
        }
        ...
        public void What_a_pane_is_drawing_survives_a_restart() {
            ...
            Assert.True(
                (
                    fixture.Viewport!.Show & SceneShow.Grid)
                == 0,
        ...
        public void So_does_the_view_mode() {
            ...
            Assert.Equal(
                ViewMode
                    .Wireframe,
                fixture.Viewport!.Modes.Current
            );
        }
    }
