...
/// </remarks>
   ...
   public
       static InspectorEditProvider  Default { get; }   =    new  ();
    ...
    ///     allocates nothing.
    /// </remarks>
  public IReadOnlyList<IEditMember > MembersOf   (   Type
  type)   {
    ...
    /// <inheritdoc />
               public bool TryResolve(Type type, string path   ,   [    NotNullWhen(true)] out    IEditMember    ? member   ) { ArgumentNullException   .  ThrowIfNull (type) ;
