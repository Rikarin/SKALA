...
namespace Vixen.Editor.ShaderGraph
    ...
    public sealed class ShaderGraphPreviewRenderer : INodePreviewSource, IDisposable {
        ...
        public bool TryGet(
            ...
            var compilation = ShaderGraphPreview.Compile(
                graph,
                node
                    .Id,
                registry
        ...
        bool Build(NodeId id, Entry entry) {
            ...
            entry.Vertex = device.CreateShader(
                ShaderStage.Vertex,
                Bytecode(effect, ShaderStage.Vertex),
                "preview vertex"
            );
            entry.
