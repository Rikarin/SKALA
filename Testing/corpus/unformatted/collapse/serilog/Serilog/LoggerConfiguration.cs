...
public class LoggerConfiguration {
    ...
    public LoggerMinimumLevelConfiguration MinimumLevel { get { return new(
                this,
                l => { _minimumLevel = l; _levelSwitch = null; },
                sw => _levelSwitch = sw,
    ...
    /// </summary>
    public LoggerDestructuringConfiguration Destructure { get { return new(
                this,
    ...
    public Logger CreateLogger() {
        ...
        var disposableSinks = _logEventSinks.Concat(_auditSinks)
