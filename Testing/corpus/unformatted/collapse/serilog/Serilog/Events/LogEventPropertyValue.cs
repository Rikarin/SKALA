...
public string ToString(string?format,IFormatProvider?formatProvider){using var output=ReusableStringWriter.GetOrCreate();Render(output,format,formatProvider);return output.ToString();}}
