...
public class LogEvent {
    ...
    public LogEvent(
        ...
        foreach (var property in properties) AddOrUpdateProperty(property);
    }
    ...
    internal LogEvent(
        ...
        exception,
        messageTemplate,
        new Dictionary<string, LogEventPropertyValue>(Guard.AgainstNull(properties).Length),
        traceId,
        spanId
    ) {
        for (var i = 0; i < properties.Length; ++i) _properties[properties[i].Name] = properties[i].Value;
    }
