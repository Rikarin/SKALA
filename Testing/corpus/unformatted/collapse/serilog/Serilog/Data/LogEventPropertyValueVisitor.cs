...
protected virtual TResult VisitUnsupportedValue(TState state,LogEventPropertyValue value){Guard.AgainstNull(value);throw new NotSupportedException($"The value {value} is not of a type supported by this visitor." );}}
