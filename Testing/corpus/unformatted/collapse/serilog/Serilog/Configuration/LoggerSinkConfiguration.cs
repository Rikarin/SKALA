...
public class LoggerSinkConfiguration {
    ...
    public LoggerConfiguration Sink(
        ...
        LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum, // The warning here is redundant; the optional parameter allows `WriteTo.Sink(s)` usage. We would obsolete the two-argument
