...
namespace Serilog.Core.Sinks; sealed class OptionalInterfaceForwardingSink : ILogEventSink,
    IDisposable,
...
#endif
{
    ...
    public static bool SupportsAny(ILogEventSink possibleReceiver) {
        return possibleReceiver is ISetLoggingFailureListener or IDisposable
#if FEATURE_ASYNCDISPOSABLE
                or IAsyncDisposable
#endif
            ;
    ...
    public static bool SupportsAll(ILogEventSink possibleReceiver) {
        return possibleReceiver is ISetLoggingFailureListener and IDisposable
#if FEATURE_ASYNCDISPOSABLE
