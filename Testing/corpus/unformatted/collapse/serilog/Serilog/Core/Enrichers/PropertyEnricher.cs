...
/// </summary>
public class PropertyEnricher:ILogEventEnricher{readonly string _name;readonly object?_value;readonly bool _destructureObjects;
/// <summary>
...
public PropertyEnricher(string name,object?value,bool destructureObjects=false){LogEventProperty.EnsureValidName(name);_name=name;_value=value;_destructureObjects=destructureObjects;}
/// <summary>
...
public void Enrich(LogEvent logEvent,ILogEventPropertyFactory propertyFactory){Guard.AgainstNull(logEvent);Guard.AgainstNull(propertyFactory);logEvent.AddPropertyIfAbsent(propertyFactory,_name,_value,_destructureObjects);}}
