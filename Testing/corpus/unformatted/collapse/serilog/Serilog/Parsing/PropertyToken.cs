...
/// </summary>
public sealed class PropertyToken:MessageTemplateToken{readonly int?_position;
/// <summary>
...
public PropertyToken(string propertyName,string rawText,string?format=null,in Alignment?alignment=null,Destructuring destructuring=Destructuring.Default){PropertyName=Guard.AgainstNull(propertyName);Format=format;Destructuring=destructuring;RawText=Guard.AgainstNull(rawText);Alignment=alignment;if(int.TryParse(PropertyName,NumberStyles.None,CultureInfo.InvariantCulture,out var position)&&position>=0){_position=position;}}
/// <summary>
    /// The token's length.
    /// </summary>
...
public override void Render(IReadOnlyDictionary<string,LogEventPropertyValue>properties,TextWriter output,IFormatProvider?formatProvider=null){Guard.AgainstNull(properties);Guard.AgainstNull(output);MessageTemplateRenderer.RenderPropertyToken(this,properties,output,formatProvider,isLiteral:false,isJson:false);}
/// <summary>
    /// The property name.
    /// </summary>
...
/// <summary>
    ...
    /// </summary>
public bool IsPositional=>_position.HasValue;internal string RawText{get;}
/// <summary>
...
public bool TryGetPositionalValue(out int position){if(_position==null){position=0;return false;}position=_position.Value;return true;}
/// <summary>
...
public override bool Equals(object?obj){return obj is PropertyToken pt&&pt.Destructuring==Destructuring&&pt.Format==Format&&pt.PropertyName==PropertyName&&pt.RawText==RawText;}
/// <summary>
