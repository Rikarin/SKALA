...
public static class ControlIcons {
    ...
    public static PathBuilder Check { get; } =
        Stroke([new Vector2(4f, 12.5f), new Vector2(9.5f, 18f), new Vector2(20f, 6.5f)], 2.2f);
    ...
    public static PathBuilder ChevronDown { get; } =
        Stroke([new Vector2(5f, 9f), new Vector2(12f, 16f), new Vector2(19f, 9f)], 2.2f);
    ...
    public static PathBuilder ChevronRight { get; } =
        Stroke([new Vector2(9f, 5f), new Vector2(16f, 12f), new Vector2(9f, 19f)], 2.2f);

    /// <summary>A chevron pointing left.</summary>
    public static PathBuilder ChevronLeft { get; } =
        Stroke([new Vector2(15f, 5f), new Vector2(8f, 12f), new Vector2(15f, 19f)], 2.2f);
    ...
    static PathBuilder Cross() {
        ...
        foreach (var segment in other.Segments) {
            switch (segment.Verb) { case PathVerb.Move: path.MoveTo(segment.P2); break; case PathVerb.Line:
                    path.LineTo(segment.P2);
                    break; default: path.Close(); break; }
        }
