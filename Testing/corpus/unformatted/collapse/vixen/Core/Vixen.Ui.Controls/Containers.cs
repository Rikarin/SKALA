...
public sealed partial class Alert : Control {
    ...
    public Icon LeadingIcon { get { if (icon is not null) {
                return icon;
            } icon = Part<Icon>(); Document.Move(icon, 0); return icon; } }
...
public sealed partial class EmptyState : Control {
    ...
    public Icon Illustration { get { if (icon is not null) {
                return icon;
            } icon = Part<Icon>(); Document.Move(icon, 0); return icon; } }
