...
/// <inheritdoc />
protected override bool AcceptsFocus=>false; // ⚠ No role, and that is the population's answer rather than a gap in it. A `Panel` is a box; a
...
/// </remarks>
public sealed partial class Card:Control{UiElement?header;UiElement?footer;
/// <inheritdoc />
...
/// <inheritdoc />
protected override void OnCreated(){base.OnCreated();Body=Part("card-body" );}
/// <summary>Adds a part and puts it first.</summary>
    ...
    /// </remarks>
UiElement Prepend(string tag){var part=Part(tag);Document.Move(part,0);return part;}}
...
/// <summary>Which way it runs.</summary>
    ...
    /// </remarks>
[UiProperty(Changed=nameof(OnOrientationChanged))]public partial Orientation Orientation{get;set;}
/// <inheritdoc />
protected override void OnCreated(){base.OnCreated();AddClass(ClassOf(Orientation));}internal static string ClassOf(Orientation orientation)=>orientation==Orientation.Vertical?"vertical" :"horizontal" ;void OnOrientationChanged(Orientation previous,Orientation current){RemoveClass(ClassOf(previous));AddClass(ClassOf(current));}}
...
///     or a failure.
/// </remarks>
public sealed partial class Alert:Control{Icon?icon;
/// <inheritdoc />
protected override string TagName=>"alert" ;
/// <inheritdoc />
protected override bool AcceptsFocus=>false;
/// <summary>The heading, if it has one.</summary>
public string?Title{get=>TitlePart.Text;set=>TitlePart.Text=value;}
/// <summary>What it says.</summary>
public string?Message{get=>MessagePart.Text;set=>MessagePart.Text=value;}
...
public Icon LeadingIcon{get{if(icon is not null){return icon;}icon=Part<Icon>();Document.Move(icon,0);return icon;}}
/// <inheritdoc />
    /// <remarks>
...
/// <inheritdoc />
protected override void OnCreated(){base.OnCreated();Body=Part("alert-body" );TitlePart=Body.Add("alert-title" );MessagePart=Body.Add("alert-message" ); // ⚠ **A relation rather than a second name property, and this is the first thing in the set
...
/// </remarks>
public sealed partial class EmptyState:Control{Icon?icon;
/// <inheritdoc />
...
public string?Description{get=>DescriptionPart.Text;set=>DescriptionPart.Text=value;}
...
public Icon Illustration{get{if(icon is not null){return icon;}icon=Part<Icon>();Document.Move(icon,0);return icon;}}
/// <inheritdoc />
    /// <remarks>
...
protected override string?NativeAccessibleName=>Title;
/// <inheritdoc />
protected override void OnCreated(){base.OnCreated();TitlePart=Part("empty-title" );DescriptionPart=Part("empty-description" );Actions=Part("empty-actions" ); // The headline names it and the sentence under describes it, on `Alert`'s terms.
