...
ValueTask<string?>OpenFileAsync(FileDialogOptions options,IWindow?owner=null,CancellationToken cancellationToken=default);
/// <summary>Asks the user to pick one or more existing files.</summary>
    /// <param name="options">What to ask for.</param>
    /// <param name="owner">The window to attach the sheet to, where the platform has sheets.</param>
    /// <param name="cancellationToken">Dismisses the dialog, where the platform allows it.</param>
    /// <returns>Native paths, empty if nothing was chosen.</returns>
ValueTask<IReadOnlyList<string>>OpenFilesAsync(FileDialogOptions options,IWindow?owner=null,CancellationToken cancellationToken=default);
/// <summary>Asks the user where to save.</summary>
    /// <param name="options">What to ask for.</param>
    /// <param name="owner">The window to attach the sheet to, where the platform has sheets.</param>
    /// <param name="cancellationToken">Dismisses the dialog, where the platform allows it.</param>
    /// <returns>A native path, or <see langword="null" /> if nothing was chosen.</returns>
ValueTask<string?>SaveFileAsync(FileDialogOptions options,IWindow?owner=null,CancellationToken cancellationToken=default);
/// <summary>Asks the user to pick a folder.</summary>
    /// <param name="options">What to ask for.</param>
    /// <param name="owner">The window to attach the sheet to, where the platform has sheets.</param>
    /// <param name="cancellationToken">Dismisses the dialog, where the platform allows it.</param>
    /// <returns>A native path, or <see langword="null" /> if nothing was chosen.</returns>
ValueTask<string?>OpenFolderAsync(FileDialogOptions options,IWindow?owner=null,CancellationToken cancellationToken=default);
...
ValueTask<MessageBoxResult>ShowMessageAsync(MessageBoxOptions options,IWindow?owner=null,CancellationToken cancellationToken=default);}
