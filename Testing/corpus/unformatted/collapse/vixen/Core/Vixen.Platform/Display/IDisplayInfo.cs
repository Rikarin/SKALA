...
public sealed record DisplayInfo(int Index,string Name,Rectangle Bounds,Rectangle WorkArea,float DpiScale,DisplayMode CurrentMode,IReadOnlyList<DisplayMode>Modes,bool IsPrimary){
