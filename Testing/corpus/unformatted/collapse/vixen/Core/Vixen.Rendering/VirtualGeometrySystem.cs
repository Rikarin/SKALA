...
public sealed class VirtualGeometrySystem : IDisposable {
    ...
    /// </remarks>
    public EffectSystem? Effects { get => Visibility.Effects; set { Visibility.Effects = value; Raster.Effects =
                value; SoftwareRaster.Effects = value; Tiles.Effects = value; Resolve.Effects = value; } }

    /// <summary>Where the compute pipelines come from, on the same terms.</summary>
    public ComputePipelineCache? Pipelines { get => Visibility.Pipelines; set { Visibility.Pipelines =
                value; SoftwareRaster.Pipelines = value; Tiles.Pipelines = value; Resolve.Pipelines = value; } }
