...
using Xunit; namespace Vixen.Core.Mathematics.Tests;
...
public class MathUtilTests {
    ...
    public void Repeat_wraps_negatives_forward_where_the_remainder_operator_reflects_them() {
        ...
        Assert.Equal(0f, MathUtil.Repeat(10f, 10f), 5); // -1 % 10 is -1; a looping animation wants 9.
