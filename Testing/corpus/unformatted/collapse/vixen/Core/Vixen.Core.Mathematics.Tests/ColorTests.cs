...
public class ColorTests {
    ...
    public void The_transfer_functions_invert_each_other() =>
        Gen.Float[0f, 1f].Sample(value => Assert.Equal(
                value,
    ...
    public void Hex_parsing_accepts_every_common_spelling() {
        ...
        Assert.Equal(new(255, 128, 0, 128), withAlpha); // Compact form doubles each digit, so f is 255 rather than 15.
