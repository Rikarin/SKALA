...
public sealed class WaterRenderer : SceneRenderer, IDisposable {
    ...
    public DescriptorAllocator? Allocator { get => pass.Descriptors.Allocator; set =>
            pass.Descriptors.Allocator = value; }
    ...
    (Vector3 Direction, Vector3 Sunlight, Vector3 Sky) Lighting() {
        var star = Sun?.Sun; // ⚠ Y₀ = 0.282095, and Y₀·4π = 3.5449 is what separates a mean radiance from the coefficient
