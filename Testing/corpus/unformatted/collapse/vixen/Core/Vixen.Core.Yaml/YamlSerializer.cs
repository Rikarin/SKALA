...
public static class YamlSerializer {
    ...
    static object? Bind(
        ...
        return node switch {
            ...
            YamlMapping mapping when IsDictionary(target, out var valueType) => BindDictionary(
                mapping,
                target,
                valueType,
                options,
    ...
    static YamlNode EmitValue(object value, Type runtime, YamlSerializerOptions options, string path) {
        ...
        switch (value) { case bool flag:
                ...
                return EmitDictionary(dictionary, runtime, options, path); case IEnumerable items:
                return EmitSequence(items, runtime, options, path); default:
