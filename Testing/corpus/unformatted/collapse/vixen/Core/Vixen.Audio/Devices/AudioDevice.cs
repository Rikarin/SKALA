...
/// </param>
public readonly record struct AudioDeviceInfo(string Id,string Name,bool IsDefault,AudioFormat PreferredFormat);
...
IAudioCaptureDevice OpenCaptureDevice(in AudioCaptureOptions options)=>throw new AudioDeviceException($"The {Name} backend cannot capture audio." );}
