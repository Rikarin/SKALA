...
using System.Runtime.CompilerServices;namespace Vixen.Core.Collections;
/// <summary>
...
/// <typeparam name="T">The element type.</typeparam>
[InlineArray(4)]public struct Buffer4<T>:IInlineBuffer<T>{T element;
/// <inheritdoc />
public static int Capacity=>4;}
/// <summary>Eight elements inline.</summary>
/// <typeparam name="T">The element type.</typeparam>
[InlineArray(8)]public struct Buffer8<T>:IInlineBuffer<T>{T element;
/// <inheritdoc />
public static int Capacity=>8;}
/// <summary>Sixteen elements inline.</summary>
/// <typeparam name="T">The element type.</typeparam>
[InlineArray(16)]public struct Buffer16<T>:IInlineBuffer<T>{T element;
/// <inheritdoc />
public static int Capacity=>16;}
/// <summary>Thirty-two elements inline.</summary>
/// <typeparam name="T">The element type.</typeparam>
[InlineArray(32)]public struct Buffer32<T>:IInlineBuffer<T>{T element;
/// <inheritdoc />
