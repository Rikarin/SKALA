...
var request = Arguments.Parse(args, out var problem); if (request is null) {
    ...
    return 2;
} var result = StyleGenRunner.Run(request); foreach (var error in result.Errors) {
