...
internal static class ConstantEvaluator {
    ...
    public static object? Evaluate(BoundExpression expression) {
        switch (expression) { case BoundLiteralExpression literal:
            ...
            case BoundFieldExpression { Field.IsConst: true } field:
                return field.Field.ConstantValue; case BoundConversionExpression conversion:
                return Convert(Evaluate(conversion.Operand), conversion.Type); case BoundUnaryExpression unary:
                return EvaluateUnary(unary.OperatorKind, Evaluate(unary.Operand)); case BoundBinaryExpression binary:
            ...
            case BoundObjectCreationExpression {
                ...
                return EvaluateVector(vector, creation.Arguments); default: return null; }
    }
