...
internal sealed class MetadataLoader {
    ...
    internal TypeSymbol Resolve(LibraryTypeReference? reference, MetadataScope scope, string libraryName) {
        ...
        switch (reference.Kind) { case LibraryTypeKind.Primitive: // A primitive travels as its SpecialType, which is the identity the binder keys
                ...
                return reference.Special == SpecialType.None
                    ...
                    : BuiltInTypes.FromSpecialType(reference.Special); case LibraryTypeKind.BuiltIn:
                return BuiltInResource(reference.Special); case LibraryTypeKind.Named:
                return ResolveNamed(reference, scope, libraryName); case LibraryTypeKind.Array: {
                ...
                return reference.Name is { } name
                    ...
                    : ErrorTypeSymbol.Instance; default: return ErrorTypeSymbol.Instance; }
    }
