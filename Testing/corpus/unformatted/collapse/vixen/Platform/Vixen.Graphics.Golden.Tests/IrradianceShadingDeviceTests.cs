...
public class IrradianceShadingDeviceTests {
    ...
    static EffectKey Key(ShaderComposition composition) =>
        EffectKey.Of(
            "ForwardPlus",
            [
                new("ForwardPlus.UseIrradianceField", "true"), new("ForwardPlus.UseImageBasedLighting", "false"),
                new("ForwardPlus.UseShadows", "false"), new("ForwardPlus.UseReflectionProbe", "false"),
    ...
    static Bitmap Render(Fixture fixture, bool lit, Fills fills = Fills.Cpu) {
        ...
        var describer = new EffectPipelineDescriber(
            device
        ...
        using var probes = new IrradianceFieldRenderer {
            ...
            Device = device,
            Budget = field.BrickCount, // ⚠ The forward pass rather than the screen-space one, and this is the line that makes the
    ...
    struct Vertex {
        ...
        public static Vertex[] Quad => [
            Corner(-QuadHalf, -QuadHalf), Corner(QuadHalf, -QuadHalf), Corner(-QuadHalf, QuadHalf),
