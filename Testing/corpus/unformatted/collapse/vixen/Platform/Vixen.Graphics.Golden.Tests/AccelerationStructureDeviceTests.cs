...
using System.Runtime.InteropServices; using Vixen.Core.Mathematics; using Vixen.Graphics.Vulkan; using Vixen.Rendering; using Vixen.Rendering.Lighting; using Vixen.Rendering.Materials; using Vixen.Rendering.RayTracing; using Vixen.Rendering.ScreenProbes; using Vixen.Shaders; using Xunit; namespace Vixen.Graphics.Golden.Tests;
...
public sealed class AccelerationStructureDeviceTests {
    ...
    public void TheQueryAnswersTheRefereesRays() {
        ...
        const BufferUsage Input = BufferUsage.AccelerationStructureInput | BufferUsage.ShaderDeviceAddress;
