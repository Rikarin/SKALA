...
using Vixen.Core.Mathematics; using Xunit; namespace Vixen.Editor.Inspector.Tests;
...
public class DescriptorTests {
    ...
    public void A_member_name_becomes_a_label_a_person_can_read() {
        Assert.Equal(
            "Foam Width",
            Water.Members.Single(static m => m.Name == "FoamWidth").DisplayName
    ...
    public void A_field_is_reached_by_reference_so_a_struct_member_is_edited_in_place() {
        ...
        var material = new WaterMaterial(); // The write goes through the accessor and lands on the object, which is the whole difference
