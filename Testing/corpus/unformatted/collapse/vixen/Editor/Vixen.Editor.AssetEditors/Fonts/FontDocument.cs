...
public sealed class FontDocument : EditorDocument {
    ...
    public FontDocument(EditorProject project, AssetId asset, string path) : base(
        project,
        asset,
    ...
    static readonly (string Name, int First, int Last)[] Blocks = [
        ("Basic Latin", 0x0020, 0x007E), ("Latin-1 Supplement", 0x00A0, 0x00FF), ("Latin Extended-A", 0x0100, 0x017F),
        ("Latin Extended-B", 0x0180, 0x024F), ("Greek and Coptic", 0x0370, 0x03FF), ("Cyrillic", 0x0400, 0x04FF),
        ("General Punctuation", 0x2000, 0x206F), ("Currency Symbols", 0x20A0, 0x20BF), ("Arrows", 0x2190, 0x21FF),
        ("Mathematical Operators", 0x2200, 0x22FF), ("Box Drawing", 0x2500, 0x257F),
        ("Geometric Shapes", 0x25A0, 0x25FF), ("Miscellaneous Symbols", 0x2600, 0x26FF)
    ];
