...
public class ViewportTests {
    ...
    public void Maximise_gives_the_scene_the_window_and_gives_it_back() {
        ...
        fixture.Frames(2); // Everything but the Scene tab has gone, and the pane count inside it is untouched.
    ...
    public void A_bookmark_is_saved_by_one_command_and_recalled_by_another() {
        ...
        fixture.Open("scene");
        fixture.Frames(1);
        var pane = fixture.Viewport!; // ⚠ Recall is disabled until something has been saved. A key that does nothing and a key that
    ...
    public void Snap_to_floor_drops_the_selection_onto_what_is_under_it_and_undoes() {
        ...
        fixture.Frames(1);
        var after = fixture.Scene.World.Read<Vixen.Engine.Transforms.LocalTransform>(
            crate
    ...
    public void Move_to_view_puts_the_selection_where_the_camera_is_looking() {
        ...
        fixture.Frames(1);
        var position = fixture.Scene.World.Read<Vixen.Engine.Transforms.WorldTransform>(
            crate
        ).Value.Translation; // ⚠ At the pivot, not at the eye. Moving something to the eye puts it inside the near plane,
