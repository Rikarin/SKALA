        ...
        var result = ledger.Post(
            new(
                ...
                [
                    ...
                    new(vendor, entry.Item, -count), new(account, entry.Item, count)
                ],
    ...
    public VendorRefusal Sell(
        ...
        var result = ledger.Post(
            new(
                ...
                [
                    new(account, item, -count), new(vendor, item, count), new(vendor, currency, -price),
    ...
    public VendorRefusal BuyBack(PlayerId player, int slot, IEconomyLedger ledger, string operation) {
        ...
        var result = ledger.Post(
            new(
                ...
                [
                    new(account, entry.Currency, -entry.Paid), new(vendor, entry.Currency, entry.Paid),
                    new(vendor, entry.Item, -entry.Count), new(account, entry.Item, entry.Count)
                ],
