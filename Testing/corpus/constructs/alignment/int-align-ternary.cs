...
public class IntAlignTernary {
    public string Chain(int flag) {
        return flag > 100000 ? "the first branch here" : flag > 500 ? "the second branch here" : flag > 1 ? "third" : "d";
    }

    public string Widths(int flag, int other) {
        return flag > 1 ? "the first branch here" : other > 50000 ? "the second branch here" : flag > 500 ? "third" : "d";
    }
