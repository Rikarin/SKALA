...
public class TernaryChains {
    public string Chopped(int flag) {
        ...
        var chain = flag > 10 ? "the first branch here" : flag > 5 ? "the second branch here" : flag > 1 ? "third" : "d";
        return chain;
    }

    public string Returned(int flag) {
        return flag > 10 ? "the first branch here it is" : flag > 5 ? "the second branch here" : flag > 1 ? "third" : "d";
    }
    ...
    public string KeptAtOneSignOnly(int flag) {
        ...
        return flag > 10 ? "the first branch here" : flag > 5 ? "the second branch here" : flag > 1 ? "third"
            : "d";
    }
    ...
    public string KeptAtOneSignOnlyInsideTheMargin(int flag) {
        ...
        return flag > 10 ? "a" : flag > 5 ? "b" : flag > 1 ? "c"
            : "d";
    }

    public void Argument(int flag) {
        Use(flag > 10 ? "the first branch here it is now" : flag > 5 ? "the second branch here" : flag > 1 ? "third" : "d");
    }
    ...
    public string NestedOnTheTrueSide(int flag) {
        ...
        return flag > 10 ? flag > 100 ? "the innermost branch here" : "the middle branch here" : "the outer branch here";
    }
    ...
    public string ParenthesisedTail(int flag) {
        ...
        return flag > 10 ? "the first branch here and more" : (flag > 5 ? "the second branch here" : flag > 1 ? "t" : "d");
    }
