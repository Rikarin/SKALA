...
public class TupleComponents {
    ...
    public void Wraps() {
        var wrapped = (FirstComponentName: 1, SecondComponentName: 2, AThirdComponentName: 3, FourthComponentName: 4, FifthComponentName: 5);
    ...
    public void FillsRatherThanChops() {
        var filled = (FirstComponentName: 1, SecondComponentName: 2, AThirdComponentName: 3, FourthComponentName: 4, FifthComponentName: 5, SixthComponentName: 6, SeventhComponentName: 7);
    ...
    public void KeepsItsParentheses() {
        var kept = (FirstComponentNameThatIsLong: 1, SecondComponentNameThatIsLong: 2, AThirdComponentNameLong: 3, FourthComponentNameLong: 4, FifthComponentNameThatIsLong: 5, SixthComponentNameIsLong: 6);
    ...
    public void KeepsTheAuthorsBreaks() {
        var pinned = (FirstComponentName: 1,
            SecondComponentName: 2, AThirdComponentName: 3, FourthComponentName: 4, FifthComponentName: 5, SixthComponentName: 6);
