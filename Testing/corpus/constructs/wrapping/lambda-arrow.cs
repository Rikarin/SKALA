...
class LambdaArrow {
    void M() {
        ...
        // `delegate(…)` one below.
        Use((SomeVeryLongParameterTypeName firstParameterName, AnotherLongParameterTypeName secondParameterName, ThirdParameterTypeName thirdParameterName) => firstParameterName);
