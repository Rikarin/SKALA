...
public class TypeParameterConstraints {
    ...
    public void FourLongConstraintsThatCannotFit<TFirst, TSecond, TThird, TFourth>(TFirst a) where TFirst : class, IDisposable where TSecond : struct, IComparable where TThird : notnull, ICloneable where TFourth : IDisposable, IEquatable<TFourth> { }
    ...
    public void TwoThatFitOnTheContinuationLine<TFirst, TSecond>(TFirst a) where TFirst : class where TSecond : struct, IComparable, ICloneable, IEquatable<TSecond> { }
    ...
    public void Local() {
        void Inner<TFirst, TSecond>(TFirst a) where TFirst : class, IDisposable, ICloneable, IEquatable<TFirst> where TSecond : struct, IComparable { }

        Inner<string, int>("a");
    }
}

public class GenericWithConstraints<TFirst, TSecond> where TFirst : class, IDisposable, ICloneable, IEquatable<TFirst> where TSecond : struct, IComparable {
