...
public class VariableDesignation {
    ...
    void Foreach(List<(int, int)> xs, List<(int, int, int, int)> wide) {
        ...
        foreach (var (someVeryLongVariableNameNumberOne, someVeryLongVariableNameNumberTwo, someVeryLongVariableNameNumberThree, x) in wide) { }
    }

    bool Pattern(object o) => o is var (a,
        b);
