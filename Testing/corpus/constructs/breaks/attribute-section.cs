...
public class AttributeSection {
    ...
    [Obsolete("a very long message that runs the line out past the margin of one hundred and twenty columns"), Serializable]
    ...
    void Parameter([Obsolete,
        CLSCompliant(true)] int a) { }

    void ParameterAfterOpen([
        Obsolete, CLSCompliant(true)] int a) { }

    void FilledParameter([Obsolete("a long message that runs on and on"), Serializable, CLSCompliant(true), Obsolete("bbb"), Serializable, CLSCompliant(false)] int a) { }

    void FittingParameterSection([Obsolete("a long message that runs on"), Serializable, CLSCompliant(true), Obsolete("bbb")] int a) { }

    void KeptAfterClose([Obsolete, Serializable]
        int a) { }

    void SingleKeptAfterClose([Obsolete]
        int a) { }
    ...
    void Lambda() {
        Func<int, int> f = ([Obsolete,
            CLSCompliant(true)] int a) => a;
        Func<int, int> g = ([Obsolete]
            int a) => a;
    }
}
...
[Obsolete, Serializable, CLSCompliant(true), Obsolete("bbb"), Serializable, CLSCompliant(false), Obsolete("ccc"), Serializable, CLSCompliant(true)]
