...
public class NestedListInATypeArgument {
    ...
    public static void NoTuple(
        Dictionary<string, (char First, StringBuilder Second)> p13,
        ValueTask<int> p14,
        Dictionary<Dictionary<SomeVeryLongTypeNameNumberOne, List<SomeVeryLongTypeNameNumberTwo>>,
            List<Dictionary<SomeVeryLongTypeNameNumberOne, SomeVeryLongTypeNameNumberTwo>>> p15
    ) { }

    public static void SectionAloneWhole(
        Dictionary<string, (char First, StringBuilder Second)> p13,
        ValueTask<int> p14,
        [Obsolete]
        Dictionary<SomeVeryLongTypeNameNumberOne, SomeVeryLongTypeNameNumberTwo, SomeVeryLongTypeNameNumberTwo> p15
    ) { }

    public static void SectionAloneFilled(
        Dictionary<string, (char First, StringBuilder Second)> p13,
        ValueTask<int> p14,
        [Obsolete]
        Dictionary<SomeVeryLongTypeNameNumberOne, SomeVeryLongTypeNameNumberTwo, SomeVeryLongTypeNameNumberTwo,
            SomeVeryLongTypeNameNumberTwo> p15
    ) { }
