...
public unsafe class FunctionPointerLists {
    ...
    delegate*<SomeVeryLongTypeNameNumberOneForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin, void> TooLong;
    ...
    delegate* unmanaged[Cdecl, SuppressGCTransition, MemberFunction, Stdcall, Thiscall, Fastcall, Cdecl, SuppressGCTransition]<int, void> ConventionTooLong;

    void Local() {
        delegate*<int,
            void> p = null;
        delegate*<SomeVeryLongTypeNameNumberOneForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin, void> q = null;
    }
}
