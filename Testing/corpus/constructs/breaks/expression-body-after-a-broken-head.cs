...
public sealed record ExpressionBodyAfterABrokenHead : IDisposable, IEnumerable<object> {
    private IReadOnlyDictionary<IEnumerable<IReadOnlyList<char>>, IEnumerable<IReadOnlyList<char>>> M113<T110, T111,
        T112>() where T111 : notnull, IEquatable<T111> where T112 : unmanaged, IEquatable<T112> => builder.Items;
    ...
    private IReadOnlyDictionary<object, object> M115<T110, T111, T112>() where T111 : notnull, IEquatable<T111> where T112 : unmanaged, IEquatable<T112> => builder.Items;

    private IReadOnlyDictionary<object, object> M116<T110, T111, T112>() where T111 : notnull, IEquatable<T111> where T112 : unmanaged, IEquatable<T112> => builder.ItemsWithAVeryLongName.SelectMany(x => x);
    ...
    public ExpressionBodyAfterABrokenHead(int aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa, int bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb, int cccccccccccccccccccc) => builder.Items = 1;
