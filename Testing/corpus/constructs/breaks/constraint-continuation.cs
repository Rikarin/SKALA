...
public class ConstraintContinuation {
    void BeforeTheComma<T1>() where T1 : class
        , new() { }

    void AfterTheComma<T1>() where T1 : class,
        new() { }
    ...
    void Twice<T1>() where T1 : class
        , System.IDisposable
        , new() { }

    void SecondClause<T1, T2>() where T1 : class
        , new()
        where T2 : struct { }

    void Overflowing<T1>() where T1 : System.Collections.Generic.IEnumerable<int>, System.Collections.Generic.IList<int>, System.IDisposable, new() { }

    void WithABody<T1>() where T1 : class
        , new() {
        int x = 0;
    }
...
public class OnAType<T1> where T1 : class
    , new() { }

public class OnATypeAfter<T1> where T1 : class,
    new() { }
