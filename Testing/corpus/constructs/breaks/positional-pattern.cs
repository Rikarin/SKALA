...
public class PositionalPattern {
    bool AfterComma(object o) => o is (1,
        2);

    bool AfterOpen(object o) => o is (
        1, 2);

    bool BeforeComma(object o) => o is (1
        , 2);

    bool TooLong(object o) => o is (SomeVeryLongConstantNumberOne, SomeVeryLongConstantNumberTwo, SomeVeryLongConstantNumberThree, SomeVeryLongConstantNumberFour);

    bool Named(object o) => o is (a: 1,
        b: 2);

    bool Nested(object o) => o is (1, (2,
        3));

    int Switch(object o) => o switch {
        (1,
            2) => 1,
        (
            3, 4) => 2,
        (SomeVeryLongConstantNumberOne, SomeVeryLongConstantNumberTwo, SomeVeryLongConstantNumberThree, SomeVeryLongConstantNumberFour) => 3,
        _ => 0,
    };

    bool TupleExpressionTwin() => (1,
        2) == (1, 2);
