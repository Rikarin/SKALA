...
public class TypeArgumentList {
    ...
    void Local() {
        ...
        List<Dictionary<string,
            int>> nested = null;
        Generic<SomeVeryLongTypeNameNumberOneForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin,
        ...
        this.Field =
            new Dictionary<SomeVeryLongTypeNameNumberOneForTheMargin, SomeVeryLongTypeNameNumberTwoForTheMargin>();
        var deep =
            Generic<Dictionary<string, Dictionary<string, Dictionary<string, Dictionary<string, int>>>>, int, int>();
    }
