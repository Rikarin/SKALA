...
public class ArrayRank {
    int[,] AfterComma() => new int[1,
        2];

    int[,] AfterOpen() => new int[
        1, 2];

    int[,] BeforeComma() => new int[1
        , 2];

    int[,] BeforeClose() => new int[1, 2
        ];

    int[,] TooLong() => new int[SomeVeryLongExpressionNumberOne + SomeVeryLongExpressionNumberTwo, SomeVeryLongExpressionNumberThree + SomeVeryLongExpressionNumberFour];
