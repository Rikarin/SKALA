...
class DelimiterIndent {
    void ChoppedInvocation() {
        Consume(FirstArgumentValueNameHere, SecondArgumentValueNameHere, ThirdArgumentValueNameHere, FifthArgumentValueNameHere, FourthArgumentValue);
    }

    void ChoppedDeclaration(int firstParameterNameHere, int secondParameterNameHere, int thirdParameterNameHere, int fourthParameterNameHere) {
    }
