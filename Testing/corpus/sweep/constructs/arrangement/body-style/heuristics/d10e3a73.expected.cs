...
public class Heuristics {
    ...
    public void SingleExpression() => Console.WriteLine("x");
    ...
    public string Long(string aaaaaaaaaaaaaaaa, string bbbbbbbbbbbbbbbb, string cccccccccccccccc) =>
        aaaaaaaaaaaaaaaa + bbbbbbbbbbbbbbbb + cccccccccccccccc + aaaaaaaaaaaaaaaa + bbbbbbbbbbbbbbbb + cccccccccccccccc;

    // (a) a throw in statement position stays a block.
    public void Throws(string s) => throw new ArgumentNullException(nameof(s));
    ...
    public async void AsyncVoid() => await Task.Delay(1);
