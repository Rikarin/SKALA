...
public class PredefinedTypeDeclarations {
    ...
    public double Ratio(double numerator, double denominator) => numerator / denominator;

    public string Describe(object value, char separator) => Label + separator + value + _count + Enabled + Total;
