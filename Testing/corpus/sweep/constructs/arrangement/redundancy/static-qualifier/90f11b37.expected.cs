...
public static class StaticQualifier {
    ...
    public static int ReadsField() => StaticQualifier._shared;

    public static int ReadsProperty() => StaticQualifier.Property;
    ...
    public static void Other() {
        Console.WriteLine(StaticQualifier._shared);
    }
    ...
    // string.
    public static string Named() => nameof(StaticQualifier._shared);
}
