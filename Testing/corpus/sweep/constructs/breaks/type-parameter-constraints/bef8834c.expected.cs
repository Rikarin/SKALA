...
public class TypeParameterConstraints {
    ...
    public void TwoThatFitOnTheContinuationLine<TFirst, TSecond>(TFirst a) where TFirst : class
        where TSecond : struct, IComparable, ICloneable, IEquatable<TSecond> { }
    ...
    public void Local() {
        void Inner<TFirst, TSecond>(TFirst a) where TFirst : class, IDisposable, ICloneable, IEquatable<TFirst>
            where TSecond : struct, IComparable { }
...
public class GenericWithConstraints<TFirst, TSecond> where TFirst : class, IDisposable, ICloneable, IEquatable<TFirst>
    where TSecond : struct, IComparable {
