...
public class TypeParameterLists {
    public void WiderThanTheMargin
        <TFirstParameterName, TSecondParameterName, TThirdParameterName, TFourthParameterName, TFifthName, TSixth>() { }

    // Fits: nothing moves at any value of either key.
    public void Short<TFirst, TSecond>(TFirst a) { }
}

public class WideDeclaration
    <TFirstParameterName, TSecondParameterName, TThirdParameterName, TFourthParameterName, TFifthName, TSixthName> {
