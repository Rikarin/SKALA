...
public class LoggerAuditSinkConfiguration {
    ...
    public LoggerConfiguration Sink(
        ...
        _sinkConfiguration.Sink(logEventSink, restrictedToMinimumLevel, levelSwitch);
    ...
    public LoggerConfiguration Sink<TSink>(
        ...
        _sinkConfiguration.Sink<TSink>(restrictedToMinimumLevel, levelSwitch);
    ...
    public LoggerConfiguration Logger(
        ...
        _sinkConfiguration.Logger(configureLogger, restrictedToMinimumLevel, levelSwitch);
    ...
    public LoggerConfiguration Logger(
        ...
        _sinkConfiguration.Logger(logger, restrictedToMinimumLevel);
}
