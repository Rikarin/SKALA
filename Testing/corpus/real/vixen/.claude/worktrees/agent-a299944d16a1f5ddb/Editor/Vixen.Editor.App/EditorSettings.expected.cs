...
///     <c>PlayerBuildSettings.Target</c> — in <c>Vixen.Editor.Core</c>, because the content build
///     reads it too — is what a build ships for, and the two are separate on purpose: see that type
///     for why one field would be worse.
/// </remarks>
