...
public static class WorldNodes {
        ...
        yield return new(
            ...
            [
                ...
                new(
                    "Budget",
                    "Node budget",
                    BehaviorFieldKind.Integer,
                    "How many nodes the budgeted test may open.",
                    "256"
                ),
                new(
                    "Aborts",
        ...
        yield return new(
            ...
            [
                ...
                new(
                    ...
                    "Crossfade",
                    BehaviorFieldKind.Number,
                    "How long to blend into it, in seconds.",
                    "0.15"
                ),
                new(
                    "Wait",
                    ...
                    "Whether the task runs until it has played through.",
                    "true"
                )
            ]
        );
        ...
        yield return new(
            ...
            [
                ...
                new(
                    ...
                    "Wait for it",
                    BehaviorFieldKind.Toggle,
                    "Whether the task runs for the length of the clip.",
                    "false"
                )
            ]
        );
    ...
    public static BehaviorTreeResolver Register(
        ...
        resolver.AddService(
            "DefaultFocus",
            (in BehaviorBuildContext context) => new DefaultFocusService(context.Key("Key"))
        );
